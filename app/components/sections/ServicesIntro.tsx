...
import ServicesCards from './ServicesCards'; // ← σχετικό path, όχι alias
...
export default function ServicesIntro() {
  ...
  // Scroll progress για όλη την ενότητα (intro)
   ...
   * CROSS-FADE:     0.52 → 0.62
   * HOLD (full):    0.62 → 0.80
   * OUTRO (full):   0.80 → 1.00
   */
  ...
  return (
    <>
      {/* INTRO STICKY SECTION (Τίτλος + Lottie) */}
      <section ref={wrapRef} className="relative h-[360vh]">
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          <div className="relative z-10 h-full">
            ...
            {/* Lottie — κάτω από το κέντρο (offset) */}
            <motion.div
      ...
      {/* SERVICES CARDS SECTION (ξεχωριστό sticky/scroll) */}
      <ServicesCards />
    </>
  );
}
