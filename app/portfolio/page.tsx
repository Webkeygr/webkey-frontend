...
export default function PortfolioPage() {
  // Force black logo + language switcher μόνο σε αυτή τη σελίδα
  useEffect(() => {
    document.body.classList.add("portfolio-no-dark");
    return () => document.body.classList.remove("portfolio-no-dark");
  }, []);

  // Dummy projects (θα αντικατασταθούν με WordPress αργότερα)
  const projects = [
    {
      id: 1,
  ...
  return (
    <>
      ...
      {/* HERO – μόνο τίτλος + κείμενο, full width */}
      <section className="relative min-h-screen flex flex-col items-center justify-center text-white pt-20">
        {/* ΤΙΤΛΟΣ "Portfolio" */}
        ...
        <div className="text-center max-w-5xl px-6">
          ...
          <p className="mt-10 text-xl md:text-2xl opacity-90 leading-relaxed">
